...
class AlumnosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'procedencia' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'observation' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-11 20:04:15',
                'modified' => '2019-03-11 20:04:15'
            ],
        ];
        parent::init();
    }
