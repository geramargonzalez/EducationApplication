...
class ProfesorFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'materia' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-11 20:04:22',
                'modified' => '2019-03-11 20:04:22'
            ],
        ];
        parent::init();
    }
